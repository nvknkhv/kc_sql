SELECT  ads_campaign,
        ...
        ROUND(COUNT(DISTINCT user_id)*1.0/ MAX(COUNT(DISTINCT user_id)) OVER (PARTITION BY ads_campaign, start_date), 2) as retention
...
--ретеншт нулевого, первого, 7-го дня    
WHERE action_date - start_date IN (0, 1, 7)    
GROUP BY ads_campaign, action_date, start_date
HAVING ads_campaign NOT IN ('Другое')
